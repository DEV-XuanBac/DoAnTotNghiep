                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppColors.cardPersonal.withValues(alpha: 0.8),
                                ...
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      height: 24.h,
                                      decoration: BoxDecoration(
                                        color: AppColors.whiteCard.withValues(alpha: 
                                          0.7,
                                        ),
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const ConversationPracticeView(),
                              ),
                            );
                          },
                          child: Container(
  ...
  Widget _buildActionButton(String img) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AppColors.cardItem.withValues(alpha: 0.8),
          borderRadius: BorderRadius.circular(14.w),
        ),
        child: Image.asset(
          img,
